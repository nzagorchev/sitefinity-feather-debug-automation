...
$logsFolder = "C:\ZAGORCHEV\Feather Distributions";
...
# get project files
$files = Get-ChildItem -Path $newLocation -Recurse | where {$_.name -match ‘^Telerik.Sitefinity.Frontend.*\.csproj$’} |
